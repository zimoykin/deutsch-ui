<template>
    <div v-if="props.visible" class="absolute top-0 left-0 bg-slate-700 bg-opacity-40 w-full h-full animation-x">
        <div
            class="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 items-center m-1 bg-gradient-to-br from-slate-300 via-purple-300 to-blue-400 rounded-md shadow-md w-full lg:w-4/12 md:w-full sm:w-full h-3/5">
